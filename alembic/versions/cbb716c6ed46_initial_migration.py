...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_channels_rubika_channel_id"),
        "channels",
        ["rubika_channel_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_webhooks_workspace_id"), "webhooks", ["workspace_id"], unique=False
    )
    op.create_table(
        "workspace_members",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "role",
            sa.Enum("owner", "admin", "member", name="workspace_role_enum"),
    ...
    op.create_index(
        op.f("ix_auto_replies_channel_id"), "auto_replies", ["channel_id"], unique=False
    )
    op.create_table(
        "filters",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "action",
            sa.Enum("delete", "warn", name="filter_action_enum"),
    ...
    op.create_index(
        op.f("ix_filters_channel_id"), "filters", ["channel_id"], unique=False
    )
    op.create_table(
        "reports",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "report_type",
            sa.Enum("daily", "weekly", "monthly", name="report_type_enum"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_reports_channel_id"), "reports", ["channel_id"], unique=False
    )
    op.create_index(
        op.f("ix_reports_period_start"), "reports", ["period_start"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "sent", "failed", "cancelled", name="post_status_enum"),
    ...
    op.create_index(
        op.f("ix_scheduled_posts_status"), "scheduled_posts", ["status"], unique=False
    )
    op.create_table(
        "webhook_deliveries",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "success", "failed", name="delivery_status_enum"),
            server_default="pending",
            nullable=False,
        ),
